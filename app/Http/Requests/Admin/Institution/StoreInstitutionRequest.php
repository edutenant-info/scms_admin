...
class StoreInstitutionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug'                => ['required', 'string', 'max:200', 'alpha_dash', Rule::unique('institutions', 'slug')],
            ...
            // Account
            'email'               => ['required', 'email', 'min:4', 'max:70', Rule::unique('institutions', 'email')],
            'mobile'              => ['required', 'digits:10'],
            'password'            => ['required', 'string', 'min:3', 'max:20', 'confirmed'],

            // Domains (optional, validated only when present)
            'sub_domain'          => ['nullable', 'string', 'min:3', 'max:70', Rule::unique('institutions', 'sub_domain')],
            'domain'              => ['nullable', 'string', 'min:3', 'max:10', Rule::unique('institutions', 'domain')],
