...
class UpdateOrganisationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug'                   => ['required', 'string', 'max:255', 'alpha_dash', Rule::unique('organisations', 'slug')->ignore($organisationId)],
            'email'                  => ['required', 'email', 'max:255', Rule::unique('organisations', 'email')->ignore($organisationId)],
            'mobile'                 => ['required', 'string', 'max:20', Rule::unique('organisations', 'mobile')->ignore($organisationId)],
            'domain'                 => ['nullable', 'string', 'max:255', Rule::unique('organisations', 'domain')->ignore($organisationId)],
