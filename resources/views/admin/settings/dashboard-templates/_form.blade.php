@php
    /** @var \App\Models\DashboardTemplate $template */
...
<div class="cd"><div class="cb">
    <div class="fgrid">
        <div class="fg">
            ...
            <input type="text" name="name" class="fi noi" value="{{ $val('name') }}" placeholder="e.g. Classic Dashboard">
        ...
        <div class="fg">
            ...
            <input type="text" name="code" class="fi noi" value="{{ $val('code') }}" placeholder="auto from name e.g. classic-dashboard">
...
<div style="display:flex;justify-content:flex-end;gap:9px;margin-top:20px;">
    <a href="{{ route('admin.dashboard-templates.index') }}" class="btn bo">Cancel</a>
