...
<div class="cd"><div class="cb">
    <div class="fgrid">
        <div class="fg">
            ...
            <input type="text" name="name" class="fi noi" value="{{ $val('name') }}" minlength="3" maxlength="100" placeholder="e.g. Mathematics">
...
<div style="display:flex;justify-content:flex-end;gap:9px;margin-top:20px;">
    <a href="{{ route('admin.subjects.index') }}" class="btn bo">Cancel</a>
    <button type="submit" class="btn ba"><i class="fa-solid fa-save"></i> {{ $item->exists ? 'Update' : 'Create' }} Subject</button>
</div>
